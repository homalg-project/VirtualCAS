...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.09.12" ], [ "HomalgToCAS", ">= 2011.11.25" ], [ "RingsForHomalg", ">= 2011.06.29" ], [ "IO_ForHomalg", ">= 2011.07.25" ], [ "GAPDoc", ">= 1.0" ] ],
