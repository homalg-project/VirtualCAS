#############################################################################
##  
##  PackageInfo.g for the package `VirtualCAS'               Mohamed Barakat
##                                                          Andreas Steenpaß
##
...
#
PackageName := "VirtualCAS",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "A virtual computer algebra system",

##  See '?Extending: Version Numbers' in GAP help for an explanation
##  of valid version numbers. For an automatic package distribution update
##  you must provide a new version number even after small changes.
Version := Maximum( [
  "2011.04.13", ## Andreas' version
## this line prevents merge conflicts
  "2011.05.17", ## Mohamed's version
] ),
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/VirtualCAS/VirtualCAS-", ~.Version ),
...
Persons := [
  ...
  rec(
    ...
    IsAuthor      := true,
    IsMaintainer  := true,
    Email         := "steenpass@mathematik.uni-klde.de",
    WWWHome       := "http://www.mathematik.uni-kl.de/",
    PostalAddress := Concatenation( [
                       "Department of Mathematics\n",
                       "University of Kaiserslautern\n",
                       "67653 Kaiserslautern\n",
...
#
README_URL := 
  "http://homalg.math.rwth-aachen.de/~barakat/VirtualCAS/README.VirtualCAS",
PackageInfoURL := 
  "http://homalg.math.rwth-aachen.de/~barakat/VirtualCAS/PackageInfo.g",
...
AbstractHTML := "This package is part of the homalg-project and provides a virtual computer algebra system.",

PackageWWWHome := "http://homalg.math.rwth-aachen.de/index.php/extensions/virtualcas",
#               
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.05.14" ], [ "HomalgToCAS", ">= 2011.04.28" ], [ "RingsForHomalg", ">= 2011.04.25" ], [ "GAPDoc", ">= 1.0" ] ],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  VirtualCAS ", ~.Version, "\n",
  "by ", ~.Persons[1].FirstNames, " ", ~.Persons[1].LastName,
        " (", ~.Persons[1].WWWHome, ")\n",
  "   ", ~.Persons[2].FirstNames, " ", ~.Persons[2].LastName,
        " (", ~.Persons[2].WWWHome, ")\n",
  "Type:\n",
  "  ?VirtualCAS:      ## for the contents of the manual\n",
  "  ?VirtualCAS:x     ## for chapter/section/topic x\n",
  "----------------------------------------------------------------\n" ),
...
Keywords := [ "virtual computer algebra system" ]
